...
<section class="bg-gray-50 dark:bg-gray-900">
  <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-[87vh] lg:py-0">
          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form @submit.prevent="submit" class="space-y-4 md:space-y-6" action="#">
                  ...
                  <div class="flex items-center justify-between">
                      ...
                      <a @click="resetPassord" href="#" class="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500">Forgot password?</a>
                  </div>
